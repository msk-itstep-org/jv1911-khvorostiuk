...
public class V3__Admin extends AbstractMigration {
    @Override
    protected void migrate(NamedParameterJdbcTemplate template) throws Exception {
    ...
    private void insertAdminUser(NamedParameterJdbcTemplate template) {
        String query = "INSERT INTO users (username, password, active, email) " +
